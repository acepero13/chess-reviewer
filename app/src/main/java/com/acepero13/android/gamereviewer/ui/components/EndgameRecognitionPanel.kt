...
/**
 * Endgame Recognition Coach panel. Compact header always visible; study advice,
 * guiding questions, and chapter hint open in a dialog on tap.
 */
@Composable
        ...
        Card(
            ...
            Row(
                ...
                Column(modifier = Modifier.weight(1f)) {
                    ...
                    Text(
                        text     = "${classification.entry.name}  ·  Chapter ${classification.entry.chapter}",
                        style    = MaterialTheme.typography.bodySmall,
